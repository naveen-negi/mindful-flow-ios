// Non-duality pointers from Nisargadatta Maharaj
// Source: "Pointers From Nisargadatta" by Ramesh S. Balsekar

export const selfInquiryPointers = [
  // Preface - On Spontaneity
  ...
  // Chapter 1 - Pride of Achievement
  ...
  // Chapter 2 - Consciousness, the Only 'Capital'
  ...
  // Chapter 4 - Manifest and the Unmanifest are One
  ...
  // Chapter 5 - Awareness and Consciousness
  ...
  // Chapter 6 - Bondage of Space and Time
  ...
  // Chapter 7 - How a Jnani Sees the World
  ...
  // Chapter 9 - You are Rama, I am Rama
  ...
  // Chapter 10 - Images in Imagination
  ...
  // Chapter 12 - Manifestation is a Dream
  ...
  // Chapter 14 - Standpoint for Reading the Gita
  ...
  // Chapter 15 - Blind Youth with True Vision
  ...
  // Chapter 16 - He Came to Scoff - Dialogue Teachings
  "Didn't your self-image differ ten years ago? At age ten? As an infant? Before? Yet something unchanged persists—the sense of being, existing, presence.",
  "Isn't it the simple sense of being—conscious presence? Without consciousness, would your body exist for you? Would the world exist? Would God-questions arise?",
  "I am this-I-am or that-I-am. I am conscious presence—not this individual or that, but Conscious Presence as such.",
  "When you say 'I think I understand,' that's wrong. When you say 'I don't understand,' that's absolutely true.",
  "Objectively, I am all appearing in consciousness's mirror. Absolutely, I am that. I am the consciousness in which the world appears.",
  "Could you see without consciousness? Does existence not become purely objective—you exist in my consciousness, I in yours?",
  "Isn't our mutual experience limited to cognition acts in consciousness? Isn't our existence merely in someone else's mind—only conceptual?",
  "We are mere phenomena—phantoms—in consciousness.",
  "The body is only the Prana and consciousness physical construct. Without Prana-consciousness, it's merely a cadaver.",
  "Consciousness mistakenly identified itself with its physical covering—the psychosomatic apparatus—creating the individual.",
  "As you view yourself in dreams. In dreams, while your body rests, you create a parallel world with people including yourself. Dreams seem very real, don't they?",
  "How do you know this 'real' world isn't also a dream? It's a dream from which you must awaken by seeing false as false, unreal as unreal, transient as transient.",
  "After such awakening comes Reality. Then the world appears as phenomenal dream within sensorial perception's periphery with supposed volitional freedom.",
  "When in deep sleep, did the phenomenal world exist for you? Can you not naturally visualize your pristine state—your original being—before this body-consciousness intruded unasked, unaided?",
  "In that state, were you conscious of your existence? Certainly not.",
  "Universal manifestation exists only in consciousness, but the awakened one has his seeing's center in the Absolute.",
  "In pure being's original state, unaware of its beingness, consciousness arises like a sea wave.",
  "The world appears and disappears in consciousness. Waves rise and fall; water remains.",
  "Before all beginnings, after all endings, I am. Whatever happens, I must witness it.",
  "The world doesn't fail to exist—it exists as consciousness's appearance, the known manifested in the unknown unmanifested.",
  "What begins must end. What appears must disappear. Appearance duration varies relatively, but whatever is time and duration subject must end.",

  // Key Recurring Themes - The 'I Am' Consciousness
  ...
  // Core Principles - Individual Self
  "There is no 'me' nor 'you'; there never could be any such entities.",
  ...
  // Core Principles - Bondage & Liberation
  ...
  // Key Metaphors
  "The reflection of sun in a dew drop differs fundamentally from the sun itself—consciousness is the reflection of Awareness.",
  "Consciousness arises in Pure Being like waves on the sea's surface. Waves rise and fall; water remains.",
  "Light becomes visible only when reflected against a surface as daylight—no essential difference between manifest and unmanifest.",
  "In dreams you create a parallel world with people. Dreams seem real—how do you know this 'real' world isn't also a dream?",
  "A mirror's reflection requires the object being reflected—consciousness cannot exist apart from awareness.",
  "One electricity source powering various exhibits—consciousness manifests through millions of forms.",
  "The seeker seeking truth is like a shadow seeking proof of the substance.",
  "I am the single actor playing millions of roles simultaneously—once you feel this deeply, the show ends.",
  "Consciousness itself is only a concept—thus manifestation is like the child of a barren woman (impossible).",

  // States of Consciousness - Deep Sleep
  "In deep sleep, without consciousness, no sense of individual existence arises.",
  ...
  // States of Consciousness - Dream State
  "In dreams, consciousness projects entire worlds.",
  ...
  // States of Consciousness - Waking State
  "Upon waking, consciousness creates the concept of individual 'I' through the mind.",
  ...
  // Misconceptions Addressed - Corrections
  "Your body and consciousness arose without your participation—what achievement is yours?",
  "You are neither consciousness nor the physical construct—you are that unchanging awareness.",
  "This body-consciousness came without your knowledge—you were never born, so how can you die?",
  "There is no 'me' nor 'you'—only consciousness mistakenly believing it is a person.",
  "The entire manifested universe exists only in consciousness—it's a dream.",
  "Liberation is recognition that bondage never existed—when the entity-concept dissolves, freedom is revealed.",
  "Truth cannot be proved or grasped intellectually—that which is sought is the seeker himself.",
  "'I am' itself is God—consciousness is your connection to the Absolute.",
  "Without identification with the body-mind, sorrow becomes impossible.",
